...
TBox 作为本地桌面端开发者工具箱的产品定位与总体行为边界。
...
### Requirement: Differentiating Capabilities
系统 SHALL 提供国密算法（SM2/SM3/SM4）支持，并强调本地隐私与批量处理能力作为差异化价值。

#### Scenario: SM algorithms available
- **WHEN** 用户打开国密相关工具
- **THEN** 可完成 SM2/SM3/SM4 相关操作且数据留在本地进程内处理
