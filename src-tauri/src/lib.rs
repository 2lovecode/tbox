...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::agent::list_skill_versions,
            commands::agent::restore_skill_version,
            commands::agent::restore_skill_default,
            commands::agent::get_shell_prefs,
            commands::agent::save_shell_prefs,
            commands::agent::probe_shell_commands,
